...
!(function() {
  ...
  (function() {
        ...
        e(c.querySelectorAll("*")).forEach(function(c) {
          [":before", ":after"].forEach(function(l) {
            ...
            if (
              (z &&
                (z.nextSibling &&
                  z.nextSibling.textContent.indexOf(zc) &&
                  N(z.nextSibling),
                N(z),
                (z = null)),
              v && !z)
    ...
    var vl = { fill: "currentColor" },
      ...
      ol = function() {
        Lc.autoReplaceSvg && Hl.dom.i2svg({ node: Q });
      };
    Object.defineProperty(Hl, "config", {
      ...
      (function(c) {
        ...
        cc &&
          (J.FontAwesome || (J.FontAwesome = Hl),
          bc(function() {
          ...
          (dc.hooks = Mc({}, dc.hooks, {
            addPack: function(c, l) {
              (dc.styles[c] = Mc({}, dc.styles[c] || {}, l)), Dc(), ol();
            },
            addShims: function(c) {
              var l;
              (l = dc.shims).push.apply(l, Hc(c)), Dc(), ol();
            }
          }));
      });
  })();
