...
!(function() {
      ...
      a(t.querySelectorAll("*")).forEach(function(t) {
        [":before", ":after"].forEach(function(e) {
          ...
          if (
            (i &&
              (i.nextSibling &&
                i.nextSibling.textContent.indexOf(it) &&
                T(i.nextSibling),
              T(i),
              (i = null)),
            r && !i)
  ...
  var re = { fill: "currentColor" },
    ...
    pe = function() {
      yt.autoReplaceSvg && he.dom.i2svg({ node: Q });
    };
  Object.defineProperty(he, "config", {
    get: function() {
      return yt;
    },
    set: function(e) {
    ...
    (function(t) {
      ...
      tt &&
        (J.FontAwesome || (J.FontAwesome = he),
        Ot(function() {
          Object.keys(xt.styles).length > 0 && pe(),
            yt.observeMutations &&
        ...
        (xt.hooks = gt({}, xt.hooks, {
          addPack: function(t, e) {
            (xt.styles[t] = gt({}, xt.styles[t] || {}, e)), Yt(), pe();
          },
          addShims: function(t) {
            var e;
            (e = xt.shims).push.apply(e, ht(t)), Yt(), pe();
          }
        }));
    });
})();
